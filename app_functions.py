...
def input_answer():
    ...
    """
    # complete this function below here
    user_answer = input("Please enter the answer to the question: ").strip()
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    # complete this function below here
    if question_type == "sum":
        correct_ans = die_1_value + die_2_value
        print(f"No! The sum of {die_1_value} and {die_2_value} is {correct_ans}!")
    else:
        correct_ans = abs(die_1_value - die_2_value)
        print(f"No! The difference between {die_1_value} and {die_2_value} is {correct_ans}!")
